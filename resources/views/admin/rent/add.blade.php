    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">thêm dữ liệu thuê</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <form class="col-lg-12" action="{{route('admin.rent.update', $rent->rent_id)}}" method="POST" id="admin-rent-edit">
              @csrf  
              <input type="hidden" name="rent_status" value="1">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="date" class="form-control form-control-sm" id="rent_start_date" name="rent_start_date">
                      </div>
                      <div class="col-md-4">
                        <label for="rent_end_date" class="form-label-sm">Ngày kết thúc thuê</label>
                        <input type="date" class="form-control form-control-sm" id="rent_end_date" name="rent_end_date">
                      </div>
                      <div class="col-md-12">
