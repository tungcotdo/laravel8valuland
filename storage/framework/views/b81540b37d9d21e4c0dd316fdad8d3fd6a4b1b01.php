...
<?php $__env->startSection('admin.main'); ?>
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <form class="col-lg-12" action="<?php echo e(route('admin.rent.update', $rent->rent_id)); ?>" method="POST" id="admin-rent-edit">
              <?php echo csrf_field(); ?>  
              <input type="hidden" name="rent_status" value="<?php echo e($rent->rent_status); ?>">
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <select class="form-control form-control-sm" id="rent_subdivision" name="rent_subdivision">
                          <?php if( !empty( $house->_SUBDIVISION ) ): ?>
                            <?php $__currentLoopData = $house->_SUBDIVISION; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($value); ?>" <?php echo e($value == $rent->rent_subdivision ? 'selected' : ''); ?>><?php echo e($text); ?></option>
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" id="rent_building" name="rent_building" value="<?php echo e($rent->rent_building); ?>">
                      </div>
                      <div class="col-md-4">
                        <label for="rent_floor" class="form-label-sm">Tầng</label>
                        <input type="text" class="form-control form-control-sm" id="rent_floor" name="rent_floor" value="<?php echo e($rent->rent_floor); ?>">
                      </div>
                        ...
                        <select class="form-control form-control-sm" id="rent_room" name="rent_room">
                          <?php if( !empty( $house->_ROOM ) ): ?>
                            <?php $__currentLoopData = $house->_ROOM; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($value); ?>" <?php echo e($value == $rent->rent_room ? 'selected' : ''); ?>><?php echo e($text); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php endif; ?>
                        </select>
                      </div>
                        ...
                        <select class="form-control form-control-sm" id="rent_style" name="rent_style">
                          <?php if( !empty( $house->_STYLE ) ): ?>
                            <?php $__currentLoopData = $house->_STYLE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($value); ?>" <?php echo e($value == $rent->rent_style ? 'selected' : ''); ?>><?php echo e($text); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php endif; ?>
                        </select>
                      </div>
                        ...
                        <select class="form-control form-control-sm" id="rent_direction" name="rent_direction">
                          <?php if( !empty( $house->_DIRECTION ) ): ?>
                            <?php $__currentLoopData = $house->_DIRECTION; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($value); ?>" <?php echo e($value == $rent->rent_direction ? 'selected' : ''); ?>><?php echo e($text); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php endif; ?>
                        </select>
                      </div>
    ...
    <?php $__env->startSection('admin.script'); ?>
      <script src="<?php echo e(asset('form/rent-img.js')); ?>"></script>
      <script src="<?php echo e(asset('form/rent-video.js')); ?>"></script>
