...
<div class="col-lg-2">  
    <div class="card">
        <div class="card-body text-center">
            <a onclick="return confirm('Bạn có muốn xóa ảnh này không?')"  href="<?php echo e(route('admin.saleimg.delete', $value->sale_img_id)); ?>" class="btn btn-sm btn-danger"><i class="small bi bi-trash"> Xóa</i> </a>
        </div>
