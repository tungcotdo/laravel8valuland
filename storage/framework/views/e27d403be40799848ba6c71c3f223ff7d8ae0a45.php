    ...
    <div class="col-lg-2">  
        <div class="card">
            <div class="card-body text-center">
                <button onclick="return confirm('Bạn có muốn xóa ảnh này không?')" type="button"  id="<?php echo e(route('shared.rentimg.delete', $value->rent_img_id)); ?>" class="btn btn-sm btn-danger rent-img-delete"><i class="small bi bi-trash"> Xóa</i> </button>
            </div>
